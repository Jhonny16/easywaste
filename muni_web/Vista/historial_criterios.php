...
<div class="wrapper">
    ...
    <div class="content-wrapper"          style="background-image: linear-gradient(150deg, rgb(255,255,255) 300px, rgb(4,216,205)95%);">
        ...
        <section class="content-header">
            <h1>
                Historial
                <small id="operation">Criterios</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-2">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <span style="color: #999580">El filtro por rango de fechas afecta a la fecha de operacion
                                de los criterios</span>
                            </div>
                             <div class="form-group">
                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <h3 class="box-title" style="color: #245269">Hitorial de cambios - Criterios
                            </h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-xs-12 col-lg-12">
                                    <div id="historial_criterios_list"></div>
                                </div>
...
<script src="../js/historial_criterios.js"></script>
